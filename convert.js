...
const getStart = (stringType, variableName) => {
  ...
  if (stringType === JSON_DOUBLE) {
    variableName =
      variableName && variableName.length ? variableName : "output";
...
const clearField = (field, defaultSelection = "") => {
  field.value =
    defaultSelection !== null && defaultSelection.toString
...
export { DEFAULT_STRING_TYPE };
export { DEFAULT_VARIABLE_NAME };
export { DEFAULT_SPACE_TYPE };
export { ECMA5_SINGLE };
export { ECMA5_DOUBLE };
export { ECMA6 };
export { JSON_DOUBLE };
...
export { SPACES_4 };
export { SPACES_8 };
export { escapeBackslash };
export { escapeSpecialCharacters };
export { getQuote };
export { getStart };
export { getEnd };
export { convertText };
